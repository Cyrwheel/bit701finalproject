...
public class BoardController {
    ...
    //버켓이름지정
    private String bucketName="bit701-bucket.108"; //각자 자기 버켓이름
    ...
    public String photoUpload(MultipartFile upload)
    {
        if(photo!=null){
            //이전 사진 삭제
            storageService.deleteFile(bucketName,"board",photo); //파일명이 photo로 된것 삭제
        }
    ...
    public Map<String, Object> list(@RequestParam(defaultValue = "1") int currentPage)
    {
        ...
        List<BoardDto> list=boardService.getPaginList(startNum,perPage);
    ...
    public void delete(int num)
    {
        ...
        String perPhoto=boardService.detailPage(num).getPhoto();
